        ...
        <PublicLayout>
            <main className={'col start'}>
                ...
                <section className={`row bet max ${css.bl1}`}>
                    ...
                    <div className={`row`}>
                        <img src="images/clients/client2.png" alt="people" width="281" height="139" loading="lazy"/>
                        <div className={css.bl2}>
                            <p>До 60% экономии</p>
                    ...
                    <div className={`row`}>
                        <img src="images/clients/client4.png" alt="people" width="281" height="138" loading="lazy"/>
                        <div className={css.bl2}>
                            <p>7 предложений</p>
                    ...
                    <div className={`row`}>
                        <img src="images/clients/client5.png" alt="people" width="281" height="150" loading="lazy"/>
                        <div className={css.bl2}>
                            <p>Конфиденциально</p>
                    ...
                    <div className={`row`}>
                        <img src="images/clients/client6.png" alt="people" width="281" height="139" loading="lazy"/>
                        <div className={css.bl2}>
                            <p>21 000 отзывов</p>
                ...
                <div className={`row bet ${css.st1}`}>
                    <div className="col start max">
                        <h1>Как найти мастера или бригаду на сайте Построй Ка?</h1>
                        <p>От «мастера на час» до строительной компании — одинаково простая схема поиска, сравнения,
                            выбора и работы</p>
                    </div>
                </div>
                <section className={`row max bet ${css.iii}`}>
