                    ...
                    <div className={`row bet`}>
                        <div className={`col ${css.m1}`}>
                            ...
                            <div>
                                ...
                                <img src="/images/formasters/master2.png" alt="master" width="141" height="130" loading="lazy"/>
                            </div>
                            <div>
                                <p>Абсолютно бесплатно и без комиссии</p>
                                <img src="/images/formasters/master3.png" alt="master" width="100" height="113" loading="lazy"/>
                            </div>
                        </div>
                    ...
                    <div className={`row bet`}>
                        <div>
                            <div className={`row bet ${css.ho}`}>
                                <img src="/images/formasters/imgone.png" alt="one" width="189" height="188" loading="lazy"/>
                                ...
                                <span><img src="/images/formasters/Line.png" width="322" height="101" alt="line" loading="lazy"/></span>
                            </div>
                            <span className={css.sp}>Р А З</span>
                        </div>
                        <div>
                            <div className={`row bet ${css.ho}`}>
                                <img src="/images/formasters/imgtwo.png" width="189" height="188" alt="one" loading="lazy"/>
