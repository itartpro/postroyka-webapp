            ...
            <div className={css.wrap}>
                <div ref={sliderRef} className={css.d1}>
                    <div key={0} className={'row bet '+css.show} ref={el => slides.current[0] = el}>
                        ...
                        <img src={`${process.env.NEXT_PUBLIC_STATIC_URL}/public/images/home/people1.png`} alt="построить дом" width="365" height="300" loading="lazy"/>
                    </div>
                    <div key={1} className={'row bet'} ref={el => slides.current[1] = el}>
                        ...
                        <img src={`${process.env.NEXT_PUBLIC_STATIC_URL}/public/images/home/people2.png`} alt="найти работу" width="366" height="299" loading="lazy"/>
                    </div>
                    <div key={2} className={'row bet'} ref={el => slides.current[2] = el}>
                        ...
                        <img src={`${process.env.NEXT_PUBLIC_STATIC_URL}/public/images/home/people3.png`} alt="Выбрать мастера" width="366" height="299" loading="lazy"/>
                    </div>
                </div>
                {slider  && (
