...
const Order = () => {
    ...
    return (
        <div className={`row bet ${css.box}`}>
            ...
            <p>Требуется выполнить работу: расчистка участка, покраска, копка, работа с растениями, покос травы, кладка блоков, погрузка и разгрузка строительных материалов, подъем на этаж и прочие работы.</p>
            <div className={`row bet`}>
